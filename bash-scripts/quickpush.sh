...
## Press enter to push committed files to Github remote repo associated with this directory.
...
## Check the status again to make sure the working tree is clean
git status
exit 0